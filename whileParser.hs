...
happyExpList = Happy_Data_Array.listArray (0,65) ([1664,2,256,33184,0,512,32768,0,0,2180,4096,0,0,4224,16385,136,20504,26624,32,40960,0,0,8192,49152,1,0,0,6144,80,10252,0,32,0,3328,4,4112,0,0,368,0,3072,40,5126,768,10,0,0,1,128,0,53248,64,0,1,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_calc","Stmt","AExpr","BExpr","int","var","bool","'skip'","'if'","'then'","'else'","'not'","'+'","'-'","'*'","'('","')'","':='","';'","'='","%eof"]
        bit_start = st * 23
        bit_end = (st + 1) * 23
...
action_2 (18) = happyShift action_2
...
action_23 (18) = happyShift action_2
...
action_28 (7) = happyShift action_17
...
action_29 (7) = happyShift action_17
